...
class Trainer:
    ...
    def __init__(self, dataset, model):
        ...
        self.loss = ploss
        data = None
        with open('../data/assignment1/sonar_data.pkl', 'rb') as f:
            data = pickle.load(f)
    ...
    def accuracy(self, data):
        ...
        return 100 * np.mean([1 if self.predict(x) == y else 0 for x, y in data])

    def predict(self, v):
        return self.model._a(np.dot(self.model.w, v))
