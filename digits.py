...
class Digits_Model:
    ...
    def __str__(self):
        ...
        \tbias2: %s\n\
        \tActivation1: %s\n\
        \tActivation2: %s\n"% (self.dim_input, self.dim_hidden, self.dim_out, self.w1, self.w2, self.b1, self.b2, self._a1.__name__,
           self._a2.__name__)
        return info
    ...
    def save_model(self):
        ...
        '''
        pickle.dump(self, open('digits_model.pkl', 'wb'))
        pass
...
def main():
    ...
    trainer.train(lr =  0.5, ne = 10) # experiment with learning rate and number of epochs
    model.save_model()
